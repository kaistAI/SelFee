...
This code is sourced from 4960ca7 commit of https://github.com/lm-sys/FastChat/blob/main/fastchat/conversation.py
...
# selfee default template
register_conv_template(
    Conversation(
        name="selfee",
        system="Below is an instruction that describes a task. Write a response that appropriately completes the request.",
        roles=("### Instruction:", "### Answer:"),
        messages=(),
        offset=0,
        sep_style=SeparatorStyle.ADD_NEW_LINE_SINGLE,
        sep="\n\n",
